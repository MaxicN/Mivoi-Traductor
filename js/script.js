...
const codigoIdiomas = ["en", "pt", "ru", "zh", "ja", "bn", "fil", "ko", "it", "fr"];
const idiomas = ["US English Female", "Portuguese Female", "Russian Female", "Chinese Female", "Japanese Female", "Hindi Female", "Filipino Female", "Korean Female", "Italian Female", "French Female"];
...
traducir.addEventListener('click', function () {
    ...
    var langCodes = idioma.value;
    console.log("langCodes:"+langCodes);
    var text = textarea.value;
    var url = 'https://translate.googleapis.com/translate_a/single?client=gtx&sl=auto&tl=' + langCodes + '&dt=t&q=' + text;
